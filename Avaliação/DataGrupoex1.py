...
def menu():
    ...
    while True:
        ...
        print("1. Menu de nomes")
        print("2. Menu de salários")
        print("3. Menu de datas")
        print("4. Menu de idades")
        print("0. Sair")
        ...
        if opcao == "1":
            while True:
                ...
                if opcao1 == "1":
                    ...
                    print(nomes.mostra_mediana())
                elif opcao1 == "3":
                    print(nomes.mostra_maior())
                elif opcao1 == "4":
                    print(nomes.mostra_menor())
                elif opcao1 == "5":
                    print(nomes.listar_em_ordem())
                elif opcao1 == "0":
                    break
            ...
            while True:
                ...
                if opcao2 == "1":
                    ...
                    print(salarios.mostra_mediana())
                elif opcao2 == "3":
                    print(salarios.mostra_maior())
                elif opcao2 == "4":
                    print(salarios.mostra_menor())
                elif opcao2 == "5":
                    print(salarios.listar_em_ordem())
                elif opcao2 == "0":
                    break
             ...
             while True:
                ...
                if opcao3 == "1":
                    ...
                    print(datas.mostra_mediana())
                elif opcao3 == "3":
                    print(datas.mostra_maior())
                elif opcao3 == "4":
                    print(datas.mostra_menor())
                elif opcao3 == "5":
                    print(datas.listar_em_ordem())
                elif opcao3 == "0":
                    break
            ...
            while True:
                ...
                if opcao4 == "1":
                    ...
                    print(idades.mostra_mediana())
                elif opcao4 == "3":
                    print(idades.mostra_maior())
                elif opcao4 == "4":
                    print(idades.mostra_menor())
                elif opcao4 == "5":
                    print(idades.listar_em_ordem())
                elif opcao4 == "0":
                    break

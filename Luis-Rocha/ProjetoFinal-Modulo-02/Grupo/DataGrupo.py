...
def calcular_folha(lista_salarios):
    salarios_reajustados = list(map(lambda salario: salario * 1.1, lista_salarios._ListaSalarios__lista))
    custo_folha = sum(salarios_reajustados)
    print(f"O custo da folha com reajuste de 10% é: R${custo_folha:.2f}")
